...
def main():
    ...
    # Debug: Print the product model's initial and final states
    print('Product initial states:', product_model.init)
    print('Product accepting states:', product_model.final)

    # Check if there are any initial states in the product model
    if product_model.init:
        # Get the initial state from the product model
        pa_initial_state = next(iter(product_model.init))
        print('Product automaton initial state:', pa_initial_state)
    else:
        print("Error: No initial states found in the product model.")
