...
class Model(object):
    ...
    def __eq__(self, other):
        ...
        return (isinstance(other, Model)
            ...
            # Compatible with networkx 2.x
            and dict(self.g.nodes(data=True)) == dict(other.g.nodes(data=True))
            and sorted(self.g.edges(data=True)) == sorted(other.g.edges(data=True)))
